  ...
  return (
    <ScrollView style={{ backgroundColor: Colors[colorScheme].profileBackgroundOuter }}>
      ...
      <View style={[styles.buttonGroup, { backgroundColor: Colors[colorScheme].profileBackgroundInner }]}>
        <TouchableOpacity onPress={() => { navigation.navigate("DetailScreen", { item: "name", itemName: "Name" }); }} style={styles.buttonItem}>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate("DetailScreen", { item: "dateOfBirth", itemName: "Date of Birth" }); }} style={styles.buttonItem}>
          <View style={[styles.buttonItemLeft, { backgroundColor: Colors[colorScheme].profileBackgroundInner }]}>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate("DetailScreen", { item: "gender", itemName: "Gender" }); }} style={styles.buttonItem}>
          <View style={[styles.buttonItemLeft, { backgroundColor: Colors[colorScheme].profileBackgroundInner }]}>
        ...
        <TouchableOpacity onPress={() => { navigation.navigate("DetailScreen", { item: "allergies", itemName: "Allergies" }); }} style={styles.buttonItem}>
          <View style={[styles.buttonItemLeft, { backgroundColor: Colors[colorScheme].profileBackgroundInner }]}>
